...
const chatConfig = {
  dimensions: {
    sm: "sm:max-h-[500px] sm:max-w-sm",
    md: "sm:max-h-[600px] sm:max-w-md",
    lg: "sm:max-h-[700px] sm:max-w-lg",
    xl: "sm:max-h-[800px] sm:max-w-xl",
    full: "sm:h-full sm:w-full"
  },
  positions: {
  ...
  states: {
    ...
    closed: "pointer-events-none invisible scale-100 opacity-0 sm:translate-y-5"
  }
};
